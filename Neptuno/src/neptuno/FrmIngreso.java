...
public class FrmIngreso extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        usuario usu = new usuario ("root" , "eran" , "neptuno2017_3" , "localhost");
        usu.conectarusuario();
        String id = "";
        ResultSet rsUsuario = usu.consultarusuario(String.valueOf(txtusuario.getText()) , String.valueOf(txtcontra.getText()));
        ...
        try {
            while (rsUsuario.next())
            {
                ...
                id = rsUsuario.getObject(1).toString();
