...
public class Frmasteroide extends javax.swing.JFrame implements KeyListener
{
    ...
    public void paint(Graphics g)
    {
       ...
       g.drawString("Presione R para ir a menú", 40 , 580);
       ...
       g.setFont(new Font ("Arial" , Font.BOLD , 20));       
       g.drawString((ini.nombre), 370 , 70);
    ...
    Timer temporizadorexplosion = new Timer(10, new ActionListener()
    {
        public void actionPerformed (ActionEvent e)
        {
            if (explosion == 1)
    ...
    public Frmasteroide() {
        ...
        disparo = java.applet.Applet.newAudioClip(getClass().getResource("/juegoasteroide/disparo.wav"));
        espacio = java.applet.Applet.newAudioClip(getClass().getResource("/juegoasteroide/espacio.wav"));
        explo = java.applet.Applet.newAudioClip(getClass().getResource("/juegoasteroide/explosion.wav"));
        motor = java.applet.Applet.newAudioClip(getClass().getResource("/juegoasteroide/motor.wav"));
